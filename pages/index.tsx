      ...
      <main className="font-sans p-6 sm:p-12">
        <section className="text-lg text-neutral-200 ">
          ...
          <div>
            ...
            <p className="py-4">
              <span className="font-bold font-mono">pinned</span> is a simple API service
              that allows you to get the pinned repositories of any github user.
            </p>
            ...
            <p className="py-2">
              To use <span className="font-bold font-mono">pinned</span>, you just need to
              make a GET request to <span className="font-bold font-mono">pinned</span>{" "}
              API with the username of the github user you want to get the pinned repos
              from.
            </p>
            <p className="py-2">
            ...
            <p className="py-2">
              ...
              <a href="//vercel.com" className="text-blue-600 hover:text-blue-800">
                Vercel
              </a>{" "}
              pinned repositories, you just need to make a GET request to{" "}
              <Link href="/api/user/vercel" className="text-blue-600 hover:text-blue-800">
                /api/user/vercel
              </Link>
            </p>
            <p className="py-4 text-xs text-neutral-500">
              Note: This app is still in development, features may be added or removed in
              the future.
            </p>
          </div>
        </section>
        ...
        <footer className="flex flex-col">
          <span>
            Developed by{" "}
            <a href="//rubenbrandao.com" className="font-bold hover:text-blue-600">
              rubkn
            </a>
          </span>
          <span>
